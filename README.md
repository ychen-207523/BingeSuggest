...
<img src="https://github.com/svd-ncsu/BingeSuggest/blob/das/asset/header_display.png" alt="drawing" style="width:1000px;"/>
...
## Project Description
BingeSuggest is a user-friendly movie recommender that curates a tailored list of 10 movie predictions based on user-provided movie preferences. Users can input their favorite movies, and our algorithm refines recommendations based on feedback—Liked, Disliked, or Yet To Watch. Additionally, BingeSuggest offers the convenience of emailing the recommended movies, enhancing the movie-watching experience. For the system architecture and other details, please refer to our documentation [here](https://github.com/svd-ncsu/BingeSuggest/tree/das/docs)

## What docs
View our documentation outlining each class and function of BingeSuggest here
- [Backend](https://github.com/svd-ncsu/BingeSuggest/blob/das/docs/backend.md)
- [Frontend](https://github.com/svd-ncsu/BingeSuggest/blob/das/docs/frontend.md)
- [Testing](https://github.com/svd-ncsu/BingeSuggest/blob/das/docs/testing.md)

View our autogenerated doco here [Doco](https://github.com/svd-ncsu/BingeSuggest/blob/das/docs/generated_docs/)
...
## Getting Started
 ...
 Step 2:
   Follow the setup instructions in the installation documentation
    ...
    https://github.com/svd-ncsu/BingeSuggest/blob/das/docs/install.md
...
Please refer to the [CONTRIBUTING.md](https://github.com/svd-ncsu/BingeSuggest/blob/das/CONTRIBUTING.md) if you want to contribute to the BingeSuggest source code. Follow all the guidelines mentioned in the same and raise a pull request, we would love to look at it ❤️!
