...
## Documentation
Checkout for project documentation [here](https://github.com/svd-ncsu/BingesSuggest/tree/master/docs)
...
## Project Description
BingeSuggest is a user-friendly movie recommender that curates a tailored list of 10 movie predictions based on user-provided movie preferences. Users can input their favorite movies, and our algorithm refines recommendations based on feedback—Liked, Disliked, or Yet To Watch. Additionally, BingeSuggest offers the convenience of emailing the recommended movies, enhancing the movie-watching experience. For the system architecture and other details, please refer to our documentation [here](https://github.com/svd-ncsu/BingeSuggest/tree/master/docs)

## What docs
View our documentation outlining each class and function of BingeSuggest here
- [Backend](https://github.com/svd-ncsu/BingeSuggest/blob/master/docs/backend.md)
- [Frontend](https://github.com/svd-ncsu/BingeSuggest/blob/master/docs/frontend.md)
- [Testing](https://github.com/svd-ncsu/BingeSuggest/blob/master/docs/testing.md)

View our autogenerated doco here [Doco](https://github.com/svd-ncsu/BingeSuggest/blob/master/docs/generated_docs/)
...
<img src="https://github.com/svd-ncsu/BingesSuggest/blob/master/asset/recommend_mechanism.gif" width="600" height="375">

### Email Notifier
**The user sends his/her movies feedback via an email (Notify Me button)**
  
<div style="display: flex; justify-content: space-between;">
    <img src="https://github.com/svd-ncsu/BingesSuggest/blob/master/asset/email_notifier.gif" alt="Email Notifier" width="600" height="375">
    <img src="https://github.com/svd-ncsu/BingesSuggest/blob/master/asset/email.png" alt="Email" width="400" height="400">
</div>

### Create an Account
#### (NEW in project 3)
**Users can now create accounts, persisting data including their movie reviews and recommendations**
<img src="https://github.com/svd-ncsu/BingesSuggest/blob/master/asset/create_account.gif" width="600" height="375">

### Login to account
#### (NEW in project 3)
**The user can log in to their account securly with encrypted passwords stored in our database**
<img src="https://github.com/svd-ncsu/BingesSuggest/blob/master/asset/login.gif" width="600" height="375">

### Profile and Friends
#### (NEW in project 3)
**The user can add friends, view the movies reviewed by the friends, and see their reviewed movies in their profile**
<img src="https://github.com/svd-ncsu/BingesSuggest/blob/master/asset/profile.gif" width="600" height="375">

### Wall
#### (NEW in project 3)
**The user can interact with other users, by viewing a community sourced wall of recent moview reviews**
<img src="https://github.com/svd-ncsu/BingesSuggest/blob/master/asset/wall.gif" width="600" height="375">

## Project 3 Delta
Check out the significant changes that we made for Project 3 [here](https://github.com/svd-ncsu/BingesSuggest/blob/master/proj3/Proj3Changes.md)

Our grading scorecard can be found [here](https://github.com/svd-ncsu/BingesSuggest/blob/master/proj3/README.md)
...
## Getting Started
 ...
 Step 2:
   Follow the setup instructions in the installation documentation
    ...
    https://github.com/svd-ncsu/BingeSuggest/blob/master/docs/install.md
...
Please refer to the [CONTRIBUTING.md](https://github.com/svd-ncsu/BingeSuggest/blob/master/CONTRIBUTING.md) if you want to contribute to the BingeSuggest source code. Follow all the guidelines mentioned in the same and raise a pull request, we would love to look at it ❤️!
